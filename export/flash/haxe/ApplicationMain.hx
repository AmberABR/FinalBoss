...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("JamFinalBoss2022", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("JamFinalBoss2022", null, 640, 480);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "JamFinalBoss2022";
		app.meta["name"] = "JamFinalBoss2022";
